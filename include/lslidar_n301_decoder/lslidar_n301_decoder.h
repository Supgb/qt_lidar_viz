...
#include <qt_lidar_viz/LslidarN301Packet.h>
#include <qt_lidar_viz/LslidarN301Point.h>
#include <qt_lidar_viz/LslidarN301Scan.h>
#include <qt_lidar_viz/LslidarN301Sweep.h>
...
namespace lslidar_n301_msgs = qt_lidar_viz;
...
public:
    ...
    // Params modify.
    bool setMaxAngle(double angle_max);
    bool setMinAngle(double angle_min);
