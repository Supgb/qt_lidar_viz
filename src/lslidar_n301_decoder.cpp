...
bool LslidarN301Decoder::setMaxAngle(double angle_max){
    //pnh.setParam("angle_disable_max", angle_max);
    angle_disable_max = angle_max;
    return true;
}

bool LslidarN301Decoder::setMinAngle(double angle_min){
    //pnh.setParam("angle_disable_min", angle_min);
    angle_disable_min = angle_min;
    return true;
}
